...
**Versiyon:** v2.0.0 (C++ Native Edition)
...
2.  **Çıktı:** Metin (Text), Dil (Language), Olasılık (Probability) ve Zaman Damgaları (Timestamps) döner.
