...
namespace suts {
    ...
    inline std::string build(const std::string& event, 
        ...
        if (trace_id.empty() || trace_id == "unknown") j["trace_id"] = nullptr; else j["trace_id"] = trace_id;
        if (span_id.empty() || span_id == "unknown")  j["span_id"]  = nullptr; else j["span_id"]  = span_id;
        if (tenant_id.empty() || tenant_id == "unknown") j["tenant_id"] = nullptr; else j["tenant_id"] = tenant_id;
